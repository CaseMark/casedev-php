...
/**
 * @phpstan-type VaultUpdateResponseShape = array{
 *   id?: string|null,
 *   chunkStrategy?: mixed,
 ...
 * }
 */
final class VaultUpdateResponse implements BaseModel
{
    /** @use SdkModel<VaultUpdateResponseShape> */
    use SdkModel;
     ...
     * Document chunking strategy configuration.
     */
    public function withChunkStrategy(mixed $chunkStrategy): self
    {
        $self = clone $this;
