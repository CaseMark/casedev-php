...
use CaseDev\Voice\BoostList\BoostListGenerateResponse\Item;
use CaseDev\Voice\BoostList\BoostListGenerateResponse\Source;

/**
 * @phpstan-import-type ItemShape from \CaseDev\Voice\BoostList\BoostListGenerateResponse\Item
 *
 * @phpstan-type BoostListGenerateResponseShape = array{
 *   items?: list<Item|ItemShape>|null,
 *   source?: null|Source|value-of<Source>,
 *   sourceIDs?: list<string>|null,
 * }
 */
final class BoostListGenerateResponse implements BaseModel
{
    /** @use SdkModel<BoostListGenerateResponseShape> */
    use SdkModel;
