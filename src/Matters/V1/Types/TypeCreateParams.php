 ...
 *
 * @see CaseDev\Services\Matters\V1\TypesService::create()
 *
 * @phpstan-type TypeCreateParamsShape = array{
 *   name: string,
 ...
 * }
 */
final class TypeCreateParams implements BaseModel
{
    /** @use SdkModel<TypeCreateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    #[Optional('default_agent_type_id')]
    ...
    /**
     * `new TypeCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TypeCreateParams::with(name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TypeCreateParams)->withName(...)
     * ```
     */
