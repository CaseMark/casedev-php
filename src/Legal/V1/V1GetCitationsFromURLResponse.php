...
use Router\Legal\V1\V1GetCitationsFromURLResponse\Citations;

/**
 * @phpstan-import-type CitationsShape from \Router\Legal\V1\V1GetCitationsFromURLResponse\Citations
 *
