...
final class ChatTest extends TestCase
{
    ...
    {
        $result = $this->client->agent->v2->chat->create();
    ...
    {
        $result = $this->client->agent->v2->chat->delete('id');
    ...
    {
        $result = $this->client->agent->v2->chat->cancel('id');
    ...
    {
        $result = $this->client->agent->v2->chat->replyToQuestion(
            'requestID',
            id: 'id',
            answers: [['string']]
        );
    ...
    {
        $result = $this->client->agent->v2->chat->sendMessage('id');
